 ...
 */
public class tennantLoginActivity extends AppCompatActivity implements View.OnClickListener {
    EditText emailText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(tennantLoginActivity.this,e.getMessage(),Toast.LENGTH_SHORT).show();
            e.printStackTrace();
        }
    ...
    public void registerUser(View v) {
        Intent intent1 = new Intent(tennantLoginActivity.this, registrationActivity.class);
    ...
    public void guestSessionClicked(View v) throws IOException {
        Intent intent = new Intent(tennantLoginActivity.this, PostLoginSplash.class);
        ...
        mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    startActivity(new Intent(tennantLoginActivity.this, PostLoginSplash.class));
                    FirebaseUser user = mAuth.getCurrentUser();
                }
                else{
                    Toast.makeText(tennantLoginActivity.this,"Failed to login! Please check your credentials",Toast.LENGTH_LONG).show();
                    progressBar.setVisibility(View.GONE);
                }
            }
        });
